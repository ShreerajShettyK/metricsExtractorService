...
// func SendMetricsToSplunk(logger *zap.Logger, metricName string, value float64, extraFields map[string]interface{}) {
// 	// Prepare metric event with "_metrics" sourcetype
// 	metricEvent := models.SplunkMetric{
// 		Time:       time.Now().Unix(),
// 		Event:      "metric",
// 		Host:       configs.Envs.SplunkHost,
// 		Sourcetype: configs.Envs.SplunkSource,
...
// 	// Add additional fields (tags/dimensions) to the event
// 	for k, v := range extraFields {
// 		metricEvent.Fields[k] = v
// 	}
...
// 	}
// 	log.Println("sent without errors")
// }
